// lib/features/elderly/views/reminders_view.dart
...
class _RemindersViewState extends ConsumerState<RemindersView> {   
  ...
  Widget _buildReminderItem(Reminder rem, ElderlyNotifier notifier, bool canEdit, String activeElderlyId) {     
    ...
    final timeDisplay = (rem.completedAt != null && rem.completedAt!.isNotEmpty) 
        ? rem.completedAt! 
        : "TODAY";
              ...
              SizedBox(                 
                ...
                child: ElevatedButton.icon(                   
                  ...
                  style: ElevatedButton.styleFrom(                     
                    ...
                    disabledBackgroundColor: rem.isCompleted ? const Color(0xFFCBD5E1) : const Color(0xFFF1F5F9),                     
                    disabledForegroundColor: rem.isCompleted ? const Color(0xFF334155) : const Color(0xFF64748B),                     
