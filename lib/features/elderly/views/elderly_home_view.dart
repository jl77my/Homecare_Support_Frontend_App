// lib/features/elderly/views/elderly_home_view.dart
      ...
      body: state.isLoading
          ...
          : state.isLinked == false
              ...
              : RefreshIndicator(
                  ...
                  child: _buildActiveDashboardView(state, notifier, reminders, activeElderlyId),
                ),
    );
  }
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              icon: Icon(rem.isCompleted ? Icons.refresh : Icons.check, size: 24),
              label: Text(
                rem.isCompleted ? 'DONE AT ${rem.completedAt ?? "TODAY"} (Tap to Reset)' : 'MARK COMPLETED NOW',
