...
class ElderlyNotifier extends StateNotifier<ElderlyState> {      
  ...
  void _initSocket() {     
    ...
    // FIX: Set explicit transports and force connection to guarantee handshake in Chrome
    ...
    // Listen for incoming server alerts globally     
    _socket?.on('SOS_ALERT_EMITTED', (_) {       
