...
class CaregiverNotifier extends StateNotifier<CaregiverState> {      
  ...
  Future<void> fetchAssignedSeniors() async {               
    ...
    try {                     
      ...
      if (currentActive.isNotEmpty) {                           
        ...
        await fetchHealthRecords(currentActive); // ADDED                   
      }               
    } catch (e) {                     
      _handleException(e);               
    }         
  ...
  void switchElderlyContext(String elderlyId) {               
    ...
    fetchHealthRecords(elderlyId); // ADDED        
  }

  // ADDED: FETCH HEALTH RECORDS
  ...
  Future<bool> recordHealth({               
    ...
    try {                     
      ...
      // ADDED: Refresh health records automatically after a new submission
