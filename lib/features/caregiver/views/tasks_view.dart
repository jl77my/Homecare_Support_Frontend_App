...
class _TasksViewState extends ConsumerState<TasksView> {
  ...
  void _showAddTaskModal(String userRole, String activeElderlyId, bool isFamily) {
...
class _AddTaskModal extends ConsumerStatefulWidget {
  ...
  const _AddTaskModal({required this.patientId, required this.userRole, required this.isFamily});
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              child: isLoading
                  ...
                  : const Text('ADD TASK', style: TextStyle(fontWeight: FontWeight.w900, color: Colors.white)),
            ),
          ),
        ],
      ),
