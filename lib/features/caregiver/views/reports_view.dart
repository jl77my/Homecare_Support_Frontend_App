...
class _ReportsViewState extends ConsumerState<ReportsView> {         
  ...
  Widget build(BuildContext context) {               
    ...
    final todayMood = isFamily ? familyState.todayMood : caregiverState.todayMood; // Extract today's mood
      ...
      child: Column(                           
        ...
        children: [                                 
          ...
          Container(                                       
            ...
            child: Text(                                             
              report.text,                                             
              style: const TextStyle(fontSize: 13, color: Color(0xFF334155), height: 1.6, fontWeight: FontWeight.w500),                                       
            ),                                 
          ),                                 
          if (report.photoUrls.isNotEmpty) ...[                                       
            ...
            const Row(                                             
              children: [                                                   
                ...
                SizedBox(width: 6),                                                   
                Text(                                                         
                  'UPLOADED PHOTO DOCUMENTATION (1)',                                                         
          ...
          Row(                                       
            children: [                                             
              ...
              Text(                                                   
                'FAMILY ACKNOWLEDGEMENTS (${report.acknowledgements.length})',                                                   
                style: const TextStyle(fontSize: 10, fontWeight: FontWeight.w900, color: Color(0xFF94A3B8), letterSpacing: 0.8),                                             
              ),                                       
            ],                                 
          ),                                 
          const SizedBox(height: 12),                                 
          if (report.acknowledgements.isNotEmpty)                                       
            ...report.acknowledgements.map((ack) => _buildAckItem(ack)),                                 
