                          ...
                          child: Container(                                                          
                            ...
                            child: Column(                                                              
                              children: [                                                                  
                                const Text(                                                                      
                                  'BLOOD PRESSURE',                                                                      
                                  style: TextStyle(fontSize: 9, fontWeight: FontWeight.w900, color: Color(0xFF166534), letterSpacing: 0.8),                                                                  
                                ),                                                                  
                                ...
                                Container(                                                                      
                                  ...
                                  child: const Text(                                                                          
                                    'NORMAL RANGE',                                                                          
                                    style: TextStyle(fontSize: 8, fontWeight: FontWeight.w900, color: Color(0xFF15803D)),                                                                      
                                  ),                                                                  
                                ),                                                              
                              ],                                                          
                            ),                                                      
                              ...
                              children: [                                                                  
                                Text(                                                                      
                                  ...
                                  style: TextStyle(                                                                          
                                    ...
                                    color: (latestVital?.glucose ?? 100) > 140 ? const Color(0xFF991B1B) : const Color(0xFF1E40AF),                                                                          
                                    letterSpacing: 0.8,                                                                      
                                  ),                                                                  
                                ),                                                                  
                                const SizedBox(height: 6),                                                                  
                                Text(                                                                      
                                  latestVital != null ? '${latestVital.glucose}' : '--',                                                                      
                                  style: const TextStyle(fontSize: 26, fontWeight: FontWeight.w900, color: Color(0xFF0F172A), letterSpacing: -1),                                                                  
                                ),                                                                  
                                const SizedBox(height: 6),                                                                  
                                Container(                                                                      
                                  ...
                                  child: Text(                                                                          
                                    ...
                                    style: TextStyle(                                                                              
                                      fontSize: 8,                                                                              
                                      fontWeight: FontWeight.w900,                                                                              
                                      color: (latestVital?.glucose ?? 100) > 140 ? const Color(0xFFB91C1C) : const Color(0xFF1D4ED8),                                                                          
                                    ),                                                                      
                                  ),                                                                  
                                ),                                                              
                              ],                                                          
                        ...
                        children: [                                                      
                          ...
                          Expanded(                                                          
                            child: Column(                                                              
                              ...
                              children: [                                                                  
                                ...
                                Text(                                                                      
                                  latestVital != null ? '${latestVital.heartRate} BPM' : '-- BPM',                                                                      
                          ...
                          Column(                                                          
                            ...
                            children: [                                                              
                              ...
                              Text(                                                                  
                                '$stability%',                                                                  
                                style: TextStyle(fontSize: 18, fontWeight: FontWeight.w900, color: stability < 80 ? const Color(0xFFEF4444) : const Color(0xFF4ADE80)),                                                              
                              ),                                                          
                            ],                                                      
                          ),                                                  
                        ],                                              
                  ...
                  children: [                                          
                    Row(                                              
                      children: [                                                  
                        ...
                        const SizedBox(width: 8),                                                  
                        Text(                                                      
                          'Latest Care Report (${familyState.totalReportsCount})',                                                      
                      ...
                      Row(                                                  
                        children: [                                                      
                          Container(                                                          
                            ...
                            child: Text(                                                              
                              '${latestReport.category.label.toUpperCase()} ${latestReport.category.emoji}',                                                              
                              style: const TextStyle(fontSize: 10, fontWeight: FontWeight.w900, color: Color(0xFF15803D)),                                                          
                            ),                                                      
                          ),                                                      
                          const Spacer(),                                                      
                          Text(                                                              
                            DateFormat('MMM d • hh:mm a').format(latestReport.timestamp),                                                              
              ...
              children: [                                  
                const Row(                                      
                  children: [                                          
                    ...
                    SizedBox(width: 8),                                          
                    Text(                                              
                      'LATEST UPDATE FROM CAREGIVER',                                              
                      style: TextStyle(fontSize: 10, fontWeight: FontWeight.w900, color: Color(0xFF0F172A), letterSpacing: 1.0),                                          
                    ),                                      
                  ],                                  
                ),                                  
                const SizedBox(height: 12),                                  
